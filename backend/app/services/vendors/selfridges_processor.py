...
class SelfridgesProcessor:
    """Process Selfridges Excel files with GBP to EUR conversion"""
    ...
    def process(
        ...
        """
        Process Selfridges file with GBP to EUR conversion
        ...
        try:
            ...
            raise Exception(f"Failed to process Selfridges file: {str(e)}")
    ...
    def _transform_row(
        ...
        for source_col, target_col in self.COLUMN_MAPPING.items():
            ...
            if target_col == "product_ean":
                ...
                gbp_amount = self._to_float(value, "Amount")
                # Convert GBP to EUR
